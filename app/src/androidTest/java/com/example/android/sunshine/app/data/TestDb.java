...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCursor("Test Querying Location Table", c, contentValues);

        // Make sure only 1 record inserted
        assertFalse("Error: No more than one record returned from location query", c.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        long locationRowId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null,
                TestUtilities.createNorthPoleLocationValues());
        assertTrue(locationRowId != -1);    // check that insert success
        ...
        assertTrue(weatherRowId != -1);     // Check that insert success
        ...
        assertTrue("Error: No records returned from location query", c.moveToFirst());
        TestUtilities.validateCursor("Test Querying Weather Table", c, contentValues);
        assertFalse("Error: No more than one record returned from location query", c.moveToNext());
        c.close();
        db.close();
    }
